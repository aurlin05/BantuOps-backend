...
public class PerformanceMonitoringService implements HealthIndicator {
    ...
    public void initializeMetrics() {
        ...
        Gauge.builder("bantuops.system.memory.used.ratio")
                .description("Ratio of used memory")
                .register(meterRegistry, this, PerformanceMonitoringService::getMemoryUsageRatio);
                
        Gauge.builder("bantuops.system.cpu.usage")
                .description("CPU usage percentage")
                .register(meterRegistry, this, PerformanceMonitoringService::getCpuUsage);
                
        Gauge.builder("bantuops.system.uptime.seconds")
                .description("Application uptime in seconds")
                .register(meterRegistry, this, PerformanceMonitoringService::getUptimeSeconds);
    ...
    private void collectApplicationMetrics() {
        ...
        double avgQueryTime = databaseQueryTimer.mean();
        updateCustomGauge("database.query.avg.duration.ms", avgQueryTime);
        
        double avgApiResponseTime = apiResponseTimer.mean();
    ...
    private void checkPerformanceThresholds() {
        ...
        double avgApiTime = apiResponseTimer.mean();
    ...
    public Timer getCustomTimer(String name) {
        return customTimers.computeIfAbsent(name, k -> 
            Timer.builder("bantuops.custom." + name)
    ...
    public Map<String, Object> getPerformanceReport() {
        ...
        report.put("application", Map.of(
            ...
            "avg_payroll_calculation_ms", payrollCalculationTimer.mean(),
            "avg_database_query_ms", databaseQueryTimer.mean(),
            "avg_api_response_ms", apiResponseTimer.mean()
        ));
        ...
        report.put("alerts", Map.of(
            ...
            "slow_queries", databaseQueryTimer.mean() > SLOW_QUERY_THRESHOLD_MS,
            "slow_api", apiResponseTimer.mean() > SLOW_API_THRESHOLD_MS
        ));
