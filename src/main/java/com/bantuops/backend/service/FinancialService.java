 ...
 * Conforme aux exigences 2.1, 2.2, 2.3, 3.1, 3.2 pour la sécurisation des données financières
 */
@Service
@Transactional
...
public class FinancialService {
    ...
    public Invoice createInvoice(InvoiceRequest request) {
        ...
        auditService.logFinancialOperation(
            "CREATE_INVOICE", 
            savedInvoice.getId(), 
            "Création de la facture " + savedInvoice.getInvoiceNumber(),
            Map.of(
    ...
    public InvoiceCalculation calculateInvoiceAmounts(InvoiceRequest request) {
        ...
        BigDecimal vatRate = request.getVatRate() != null ? 
            request.getVatRate() : DEFAULT_VAT_RATE;
    ...
    // Méthodes de génération des sections de rapport (à implémenter dans les prochaines étapes)
