...
public interface OptimizedEmployeeRepository extends JpaRepository<Employee, Long>, JpaSpecificationExecutor<Employee> {
    ...
    @Query(value = "SELECT " +
            ...
            "ORDER BY e.department", nativeQuery = true)
    ...
    class Specs {
        ...
        public static Specification<Employee> isActive() {
            return (root, query, criteriaBuilder) -> criteriaBuilder.isTrue(root.get("employmentInfo").get("isActive"));
        }
        ...
        public static Specification<Employee> salaryBetween(Double minSalary, Double maxSalary) {
            return (root, query, criteriaBuilder) -> {
                ...
                jakarta.persistence.criteria.Path<Double> salaryPath = root.get("employmentInfo").get("baseSalary");
        ...
        public static Specification<Employee> createdBetween(LocalDate startDate, LocalDate endDate) {
            return (root, query, criteriaBuilder) -> {
                ...
                jakarta.persistence.criteria.Path<java.time.LocalDateTime> createdAtPath = root.get("createdAt");
