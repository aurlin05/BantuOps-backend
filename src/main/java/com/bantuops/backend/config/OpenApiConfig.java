 ...
 * Conforme aux exigences 4.1, 4.2, 4.3, 4.4, 4.5, 4.6 pour la documentation complète
 */
@Configuration
@OpenAPIDefinition(
    info = @Info(
...
public class OpenApiConfig {
            ...
            .content(new Content()
                .addMediaType("application/json", new MediaType()
                    .schema(new Schema<>()
                        ...
                        .addProperty("timestamp", new Schema<>().type("string").format("date-time").example("2024-01-15T10:30:00Z"))
                        .addProperty("path", new Schema<>().type("string").example("/api/payroll/calculate"))
                        .addProperty("details", new Schema<>().type("object"))
                        .addProperty("suggestion", new Schema<>().type("string").example("Veuillez vérifier les données et réessayer"))
                    )
                )
            );
    }
    ...
    private Schema<?> createPayrollRequestSchema() {
        return new Schema<>()
            ...
            .addProperty("employeeId", new Schema<>().type("integer").format("int64").description("ID unique de l'employé"))
            .addProperty("payrollPeriod", new Schema<>().type("string").pattern("\\d{4}-\\d{2}").description("Période de paie au format YYYY-MM"))
            .addProperty("baseSalary", new Schema<>().type("number").format("decimal").minimum(BigDecimal.valueOf(0)).description("Salaire de base en FCFA"))
            .addProperty("regularHours", new Schema<>().type("number").format("decimal").description("Heures normales travaillées"))
            .addProperty("overtimeHours", new Schema<>().type("number").format("decimal").description("Heures supplémentaires"))
            .addProperty("performanceBonus", new Schema<>().type("number").format("decimal").description("Prime de performance"))
            .addProperty("transportAllowance", new Schema<>().type("number").format("decimal").description("Indemnité de transport"))
            .addProperty("mealAllowance", new Schema<>().type("number").format("decimal").description("Indemnité de repas"))
    ...
    private Schema<?> createPayrollResultSchema() {
        return new Schema<>()
            ...
            .addProperty("grossSalary", new Schema<>().type("number").format("decimal").description("Salaire brut total"))
            .addProperty("netSalary", new Schema<>().type("number").format("decimal").description("Salaire net après déductions"))
            .addProperty("incomeTax", new Schema<>().type("number").format("decimal").description("Impôt sur le revenu (IRPP)"))
            .addProperty("ipresContribution", new Schema<>().type("number").format("decimal").description("Cotisation IPRES"))
            .addProperty("cssContribution", new Schema<>().type("number").format("decimal").description("Cotisation CSS"))
            .addProperty("totalAllowances", new Schema<>().type("number").format("decimal").description("Total des indemnités"))
            .addProperty("totalDeductions", new Schema<>().type("number").format("decimal").description("Total des déductions"))
            .addProperty("calculatedBy", new Schema<>().type("string").description("Utilisateur ayant effectué le calcul"))
    ...
    private Schema<?> createInvoiceRequestSchema() {
        return new Schema<>()
            ...
            .addProperty("invoiceNumber", new Schema<>().type("string").pattern("^[A-Z]{3,4}-\\d{4}-\\d{3}$").description("Numéro de facture unique"))
            ...
            .addProperty("clientAddress", new Schema<>().type("string").maxLength(500).description("Adresse du client"))
            .addProperty("clientTaxNumber", new Schema<>().type("string").pattern("\\d{13}").description("Numéro fiscal sénégalais"))
            .addProperty("subtotalAmount", new Schema<>().type("number").format("decimal").minimum(BigDecimal.valueOf(0)).description("Montant HT"))
            .addProperty("vatRate", new Schema<>().type("number").format("decimal").minimum(BigDecimal.valueOf(0)).maximum(BigDecimal.valueOf(1)).description("Taux de TVA (0.18 pour 18%)"))
            .addProperty("currency", new Schema<>().type("string").pattern("XOF|EUR|USD").description("Devise"))
            .addProperty("description", new Schema<>().type("string").maxLength(1000).description("Description des services/produits"))
    ...
    private Schema<?> createInvoiceResponseSchema() {
        return new Schema<>()
            ...
            .addProperty("vatAmount", new Schema<>().type("number").format("decimal").description("Montant de la TVA"))
            .addProperty("totalAmount", new Schema<>().type("number").format("decimal").description("Montant TTC"))
            .addProperty("status", new Schema<>().type("string").enumValue(Arrays.asList("DRAFT", "PENDING", "PAID", "OVERDUE", "CANCELLED")))
    ...
    private Schema<?> createEmployeeRequestSchema() {
        return new Schema<>()
            ...
            .addProperty("employeeNumber", new Schema<>().type("string").pattern("^EMP-\\d{3,6}$").description("Numéro unique d'employé"))
            .addProperty("firstName", new Schema<>().type("string").minLength(2).maxLength(50).description("Prénom"))
            .addProperty("lastName", new Schema<>().type("string").minLength(2).maxLength(50).description("Nom de famille"))
            .addProperty("email", new Schema<>().type("string").format("email").description("Adresse email professionnelle"))
            .addProperty("phoneNumber", new Schema<>().type("string").pattern("^\\+221[0-9]{9}$").description("Numéro de téléphone sénégalais"))
            .addProperty("nationalId", new Schema<>().type("string").pattern("\\d{13}").description("Numéro de carte d'identité"))
            .addProperty("dateOfBirth", new Schema<>().type("string").format("date").description("Date de naissance"))
            ...
            .addProperty("contractType", new Schema<>().type("string").enumValue(Arrays.asList("CDI", "CDD", "STAGE", "CONSULTANT")).description("Type de contrat"))
            .addProperty("baseSalary", new Schema<>().type("number").format("decimal").minimum(BigDecimal.valueOf(0)).description("Salaire de base"))
            .addProperty("workStartTime", new Schema<>().type("string").format("time").description("Heure de début de travail"))
            .addProperty("workEndTime", new Schema<>().type("string").format("time").description("Heure de fin de travail"))
            .addProperty("workDays", new Schema<>().type("string").description("Jours de travail séparés par des virgules"))
            .required(Arrays.asList("employeeNumber", "firstName", "lastName", "email", "position", "department", "hireDate", "contractType", "baseSalary"));
    }
    ...
    private Schema<?> createAttendanceRequestSchema() {
        return new Schema<>()
            ...
            .addProperty("type", new Schema<>().type("string").enumValue(Arrays.asList("PRESENT", "LATE", "ABSENT", "HALF_DAY")))
    ...
    private Schema<?> createAttendanceResponseSchema() {
        return new Schema<>()
            ...
            .addProperty("status", new Schema<>().type("string").enumValue(Arrays.asList("PENDING", "APPROVED", "REJECTED")))
            .addProperty("createdAt", new Schema<>().type("string").format("date-time"));
    }
    ...
    private Schema<?> createVATCalculationSchema() {
        return new Schema<>()
            ...
            .addProperty("baseAmount", new Schema<>().type("number").format("decimal").description("Montant de base HT"))
            .addProperty("vatRate", new Schema<>().type("number").format("decimal").description("Taux de TVA appliqué"))
            .addProperty("vatAmount", new Schema<>().type("number").format("decimal").description("Montant de la TVA"))
            .addProperty("totalAmount", new Schema<>().type("number").format("decimal").description("Montant TTC"))
    ...
    private Schema<?> createTaxRatesSchema() {
        return new Schema<>()
            ...
            .addProperty("ipresRate", new Schema<>().type("number").format("decimal").example(0.06).description("Taux IPRES (6%)"))
            .addProperty("cssRate", new Schema<>().type("number").format("decimal").example(0.035).description("Taux CSS (3.5%)"))
            .addProperty("vatRate", new Schema<>().type("number").format("decimal").example(0.18).description("Taux TVA (18%)"))
    ...
    private Schema<?> createErrorResponseSchema() {
        return new Schema<>()
            ...
            .addProperty("suggestion", new Schema<>().type("string").description("Suggestion pour résoudre l'erreur"))
            .addProperty("traceId", new Schema<>().type("string").description("ID de trace pour le débogage"))
            .addProperty("correlationId", new Schema<>().type("string").description("ID de corrélation pour le suivi"))
    ...
    private Schema<?> createValidationResultSchema() {
        return new Schema<>()
            ...
            .addProperty("warnings", new Schema<>().type("array").items(new Schema<>().type("string")).description("Avertissements de validation"))
    ...
    private Schema<?> createAuthenticationRequestSchema() {
        return new Schema<>()
            ...
            .addProperty("username", new Schema<>().type("string").format("email").description("Nom d'utilisateur (email)"))
    ...
    private Schema<?> createPayslipDocumentSchema() {
        return new Schema<>()
            ...
            .addProperty("pdfUrl", new Schema<>().type("string").format("uri").description("URL de téléchargement PDF"))
            .addProperty("status", new Schema<>().type("string").enumValue(Arrays.asList("GENERATED", "SIGNED", "SENT", "ARCHIVED")))
    ...
    private Schema<?> createBulkOperationResultSchema() {
        return new Schema<>()
            ...
            .addProperty("totalProcessed", new Schema<>().type("integer").description("Nombre total d'éléments traités"))
            .addProperty("successful", new Schema<>().type("integer").description("Nombre d'éléments traités avec succès"))
            ...
            .addProperty("duration", new Schema<>().type("integer").description("Durée de traitement en millisecondes"));
    }
    ...
    private Schema<?> createAuditLogSchema() {
        return new Schema<>()
            ...
            .addProperty("action", new Schema<>().type("string").enumValue(Arrays.asList("CREATE", "UPDATE", "DELETE", "VIEW")))
    ...
    private Example createPayrollResponseExample() {
        return new Example()
            ...
            .value(Map.of(
                ...
                "calculatedBy", "admin@bantuops.com",
                "calculatedAt", "2024-01-15T10:30:00Z",
                "notes", "Calcul conforme à la législation sénégalaise - Code du Travail"
            ));
    }
    ...
    private Example createAuthenticationResponseExample() {
        return new Example()
            ...
            .value(Map.of(
                "token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbkBiYW50dW9wcy5jb20iLCJyb2xlcyI6WyJBRE1JTiJdLCJleHAiOjE3MDUzMjk2MDB9.signature",
                "refreshToken", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbkBiYW50dW9wcy5jb20iLCJ0eXBlIjoicmVmcmVzaCIsImV4cCI6MTcwNTQxNjAwMH0.signature",
                "expiresIn", 86400,
                "tokenType", "Bearer",
                "user", Map.of(
                    "id", 1,
